...
public class BenchmarkTrace1NoAlgo {
	...
	public void runAllBenchmarks() {
		String trace = "/home/mmartin/Master/Traces/trace-sched-switch-delete100-109-with-lost/Sansfil-Securise-Etudiants-Lassonde-241-79.polymtl.ca/kernel/";
		String algo = "no checking";
		runOneBenchmark(trace, String.format(TEST_BUILD, trace.toString(), algo), cpu, Dimension.CPU_TIME, algo, false);
	}
	...
	private static void runOneBenchmark(@NonNull String testTrace, String testName, RunMethod method,
			Dimension dimension, String algo, boolean withInference) {
